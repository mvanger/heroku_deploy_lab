...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { make: @computer.make, model: @computer.model, processor_speed: @computer.processor_speed }
    end
  ...
  test "should update computer" do
    put :update, id: @computer, computer: { make: @computer.make, model: @computer.model, processor_speed: @computer.processor_speed }
    assert_redirected_to computer_path(assigns(:computer))
  end
